...
public class PrivecyFragment extends Fragment {

    View view;

    public PrivecyFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_privecy, container, false);

        //adding custom toolbar
        Toolbar toolbar = view.findViewById(R.id.toolbar_privecy);
